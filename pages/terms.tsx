...
const TermsPage = () => {
  return (
    <>
      <NextSeo
        title={`利用規約 | HappyHacks`}
        description={`利用規約 | HappyHacks`}
        openGraph={{
      ...
      <div>
        <div className="max-w-screen-sm px-4 xs:mx-auto mt-12 mb-20 font-sans text-main-black xs:text-[1.125rem] leading-[1.9rem] xs:leading-9 xs:tracking-wider">
          ...
          <p>
            本利用規約（以下、「本規約」といいます。）は、Takeru
            Konno（以下、「当方」といいます。）がこのウェブサイト上で提供するサービス（以下、「本サービス」といいます。）の利用条件を定めるものです。登録利用者の皆さま（以下、「利用者」といいます。）には、本規約に従って、本サービスをご利用いただきます。
          </p>
          ...
          <h3 className="text-[1.125rem] xs:text-[1.25rem] font-[600] mt-8 mb-1">
            第3条（認証情報の管理）
          </h3>
          <ol className="pl-7 m-0">
            <li className="list-decimal">
          ...
          <h3 className="text-[1.125rem] font-[600] mt-8 mb-1">
            第12条（通知または連絡）
          </h3>
