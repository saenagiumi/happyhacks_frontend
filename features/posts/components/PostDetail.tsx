      ...
      <div>
        <div className="px-5 pt-3">
          ...
          <div className="my-5 flex justify-center xs:my-6">
            <TwitterIntentTweet
              className="flex h-[39px] w-[170.95px] items-center justify-center rounded-[4px] bg-blue-400 py-2 pl-1 pr-2 font-sans text-[15px] font-[600] text-sky-50 no-underline"
              text={"\n\n対策のアイデアを募集しています\n#ADHDあるある"}
