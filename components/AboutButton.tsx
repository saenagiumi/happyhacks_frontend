  ...
  return isVisible ? (
    <div className="flex">
      <Link href={"/about"} legacyBehavior>
        <UnstyledButton className="group mx-auto flex h-[3.5rem] w-[73vw] items-center justify-end rounded-full border-2 border-solid border-amber-300 bg-white pl-5 pr-1 font-sans text-[1.1rem] font-[600] text-gray-700 hover:bg-amber-300 xs:h-[3.2rem] xs:w-[280px] lg:h-[3.5rem] lg:w-[300px]">
          <RiSearch2Line />
