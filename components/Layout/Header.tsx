        ...
        <div>
          ...
          <div className="px-1.5 py-5">
            ...
            <UnstyledButton
              ...
              className="my-6 mx-auto flex w-[200px] justify-center rounded-[6px] bg-gray-50 py-[9px] text-[14px] text-gray-700 shadow-sm shadow-gray-400 focus:outline-none focus:ring-1 focus:ring-sky-500"
            >
              ログインページへ
            </UnstyledButton>
